...
public class TelaInternaPerfil extends JPanel {
	...
	public TelaInternaPerfil() {
		...
		panel.setLayout(new MigLayout("", "[0][0][500][500][200px][][][][0]", "[150px][100px][][40][][][60][][][60][][75px]"));
		...
		panel.add(panelFundoIcone, "cell 2 2,alignx left,growy");
		...
		panel.add(btnNewButton_4, "cell 4 2,alignx left");
		...
		panel.add(textField_1, "cell 2 5 2 1,growx");
		...
		panel.add(btnNewButton_3, "cell 4 5");
		...
		panel.add(lblNewLabel, "cell 2 7");
		
		textField = new JTextField();
		panel.add(textField, "cell 2 8 2 1,growx");
		...
		panel.add(btnNewButton_2, "cell 4 8");
		...
		panel.add(btnSair, "flowx,cell 2 10,alignx left");
		...
		panel.add(btnExcluirPerfil, "cell 3 10,alignx left");
