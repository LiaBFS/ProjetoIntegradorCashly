...
public class ObjetivoMaiorQueSaldo extends JFrame {
    ...
    public ObjetivoMaiorQueSaldo() {
        ...
        JLabel lblMensagem = new JLabel("O objetivo deve ser maior que o saldo atual");
        lblMensagem.setFont(new Font("Carlito", Font.PLAIN, 15));
        lblMensagem.setBounds(110, 51, 330, 28);
        contentPane.add(lblMensagem);

        JLabel lblIcone = new JLabel("");
        lblIcone.setIcon(new ImageIcon(ObjetivoMaiorQueSaldo.class.getResource("/imgs/EmailInvalido.png")));
