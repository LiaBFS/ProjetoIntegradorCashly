...
public class SelecioneCategoria extends JDialog {
    private static final long serialVersionUID = 1L;
    private JPanel contentPane;

    public SelecioneCategoria(Window owner) {
        super(owner);
        setTitle("Categoria Obrigatória");
        ...
        JLabel lblTitulo = new JLabel("Categoria Obrigatória");
        lblTitulo.setFont(new Font("Carlito", Font.BOLD | Font.ITALIC, 20));
        lblTitulo.setBounds(110, 26, 330, 28);
        contentPane.add(lblTitulo);
        
        JLabel lblMensagem = new JLabel("Selecione uma categoria para o projeto");
        lblMensagem.setFont(new Font("Carlito", Font.PLAIN, 15));
        lblMensagem.setBounds(110, 51, 330, 28);
        contentPane.add(lblMensagem);

        JLabel lblIcone = new JLabel("");
        lblIcone.setIcon(new ImageIcon(SelecioneCategoria.class.getResource("/imgs/EmailInvalido.png")));
    ...
    public static void mostrar() {
        SelecioneCategoria dialog = new SelecioneCategoria(null);
        dialog.setVisible(true);
    }
    
    public static void mostrar(Window owner) {
        SelecioneCategoria dialog = new SelecioneCategoria(owner);
        dialog.setVisible(true);
    }
}