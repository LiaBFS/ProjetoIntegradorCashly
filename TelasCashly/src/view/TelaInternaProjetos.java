...
public class TelaInternaProjetos extends JPanel {
	...
	public TelaInternaProjetos() {
		...
		panel_4.setLayout(new MigLayout("", "[72][241,grow][241,grow][241][241][241][241][241][241][241][72]", "[grow 25][][grow 10][][][][][grow 25]"));
		...
		panel_3.setLayout(new MigLayout("", "[169][][][][155][][][][][][169]", "[][]"));
		...
		panel_3.add(btnNomeProjeto2, "cell 4 0");
		...
		panel_3.add(btnData_1, "cell 10 0");
		...
		panel_3.add(btnDescrição_1, "cell 4 1");
		
		JPanelComBackground panel_2 = new JPanelComBackground("/imgs/FundoBtn.png");
		add(panel_2, "cell 0 2,grow");
		panel_2.setLayout(new MigLayout("", "[188][][][][155][][][188]", "[][]"));
		...
		panel_2.add(btnNomeProjeto3, "cell 4 0");
		...
		panel_2.add(btnData_2, "cell 7 0");
		...
		panel_1.add(btnNomeProjeto4, "cell 4 0");
		...
		panel_1.add(btnData_3, "cell 10 0");
		...
		panel.add(btnNomeProjeto5, "cell 5 0");
		...
		panel.add(btnDescrição_4, "cell 5 1");
