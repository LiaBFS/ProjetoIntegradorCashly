...
public class SenhaInvalida extends JDialog {

    private static final long serialVersionUID = 1L;
    private JPanel contentPane;

    public SenhaInvalida(Window owner) {
        super(owner);
    ...
    public static void mostrar() {
        SenhaInvalida dialog = new SenhaInvalida(null);
        dialog.setVisible(true);
    }
    
    public static void mostrar(Window owner) {
        SenhaInvalida dialog = new SenhaInvalida(owner);
        dialog.setVisible(true);
    }
}